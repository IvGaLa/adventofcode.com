...
const day07Two = (tree) => {
  ...
  return dfs(1, getS(tree[0]));
};

//const fileInput = './2025/day07/example.txt'; // 21 - 40
const fileInput = './2025/day07/input.txt'; // 1524 - 32982105837605

console.log(day07(getTree(fileInput)));
console.log(day07Two(getTree(fileInput)));
